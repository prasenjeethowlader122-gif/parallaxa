...
export function buildArticleMetadata(
  ...
  return {
    ...
    openGraph: {
      ...
      siteName,
      type: 'article',
      publishedTime: new Date(article.date as string).toISOString(),
...
export function buildArticleJsonLd(article: NewsArticle, siteUrl: string) {
  return {
    ...
    datePublished: new Date(article.date as string).toISOString(),
    dateModified:  article.updatedAt ? new Date(article.updatedAt as string).toISOString() : new Date(article.date as string).toISOString(),
    author: [{
      '@type': 'Person',
      name: article.author,
